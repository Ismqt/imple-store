...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn("inline-flex h-10 items-center justify-center rounded-md bg-cream-100 p-1 text-brown-600", className)}
    {...props}
  />
))
